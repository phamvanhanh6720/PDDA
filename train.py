    ...
    def train(self, base_root='./weight/'):
        ...
        for k in range(self.k_fold):
            ...
            for epoch in tqdm(range(self.n_epoch)):
                ...
                loss = self.train_one_epoch(train_dataloader)

                print("Evaluating epoch {}".format(epoch + 1))
                train_result = self.eval_one_epoch(train_dataloader)
                test_result = self.eval_one_epoch(test_dataloader)
...
if __name__ == '__main__':
    ...
    trainer.train(base_root='./weight/5_fold/')
